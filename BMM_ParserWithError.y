...
%token INT SINGPRE DOUBPRE STRINGTYPE EQUAL UNEQUAL LESS GREAT LESSEQ GREATEQ NOT AND OR XOR COMMA DATA DEF DIM END FOR TO STEP GOSUB GOTO IF THEN LET PRINT INVCOMMA INPUT RETURN STOP SEMICOLON NEXT REM NEWLINE LOWER
%union{
    int num;
    char *str;
}
